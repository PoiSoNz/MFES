...
public class Document {
  ...
  public Number price;
  public Object status = Print_Service.quotes.NotPrintedQuote.getInstance();
  ...
  public void cg_init_Document_1(
    ...
    status = Print_Service.quotes.NotPrintedQuote.getInstance();
    return;
  }
  ...
  public void queued() {
    ...
    status = Print_Service.quotes.QueuedQuote.getInstance();
  }

  public void printed() {

    status = Print_Service.quotes.PrintedQuote.getInstance();
  }
  ...
  public static Number colorCostFactor(final Object color) {
    ...
    Boolean success_1 =
        Utils.equals(quotePattern_1, Print_Service.quotes.BlackWhiteQuote.getInstance());

    if (!(success_1)) {
      Object quotePattern_2 = color;
      success_1 = Utils.equals(quotePattern_2, Print_Service.quotes.ColorQuote.getInstance());
  ...
  public static Number sheetCost(final Object sheetSize) {
    ...
    Boolean success_2 = Utils.equals(quotePattern_3, Print_Service.quotes.A3Quote.getInstance());

    if (!(success_2)) {
      Object quotePattern_4 = sheetSize;
      success_2 = Utils.equals(quotePattern_4, Print_Service.quotes.A4Quote.getInstance());

      if (!(success_2)) {
        Object quotePattern_5 = sheetSize;
        success_2 = Utils.equals(quotePattern_5, Print_Service.quotes.A5Quote.getInstance());
