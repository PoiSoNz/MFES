...
public class Printer {
  ...
  private Number generateRandomDamage() {
    ...
    if (randNum.longValue() <= Utils.DAMAGE_PROBABILITY.longValue()) {
      damaged = true;
      this.createReport(Print_Service.quotes.DamagedQuote.getInstance());
    }
  ...
  private Boolean existsReport(final Object reportType) {
    ...
    VDMSet set_12 = SeqUtil.elems(Utils.copy(openReports));
    for (Iterator iterator_12 = set_12.iterator();
        iterator_12.hasNext() && !(existsExpResult_4);
        ) {
      Report report = ((Report) iterator_12.next());
  ...
  public void removeReport(final Object malfunction) {
    ...
    for (Iterator iterator_24 = SeqUtil.inds(openReports).iterator(); iterator_24.hasNext(); ) {
  ...
  private static Number getInkCartridgeIndex(final Object color) {
    ...
    Boolean success_3 =
        Utils.equals(quotePattern_6, Print_Service.quotes.BlackWhiteQuote.getInstance());

    if (!(success_3)) {
      Object quotePattern_7 = color;
      success_3 = Utils.equals(quotePattern_7, Print_Service.quotes.ColorQuote.getInstance());

      if (success_3) {
        casesExpResult_3 = Utils.COLOR_INK_CARTDG_IDX;
      }

    } else {
      casesExpResult_3 = Utils.BLACK_INK_CARTDG_IDX;
    }
  ...
  private static Number getPaperSizeIndex(final Object paperSize) {
    ...
    Boolean success_4 = Utils.equals(quotePattern_8, Print_Service.quotes.A3Quote.getInstance());

    if (!(success_4)) {
      Object quotePattern_9 = paperSize;
      success_4 = Utils.equals(quotePattern_9, Print_Service.quotes.A4Quote.getInstance());

      if (!(success_4)) {
        Object quotePattern_10 = paperSize;
        success_4 = Utils.equals(quotePattern_10, Print_Service.quotes.A5Quote.getInstance());

        if (success_4) {
          casesExpResult_4 = Utils.A5_PAPER_IDX;
        }

      } else {
        casesExpResult_4 = Utils.A4_PAPER_IDX;
      }

    } else {
      casesExpResult_4 = Utils.A3_PAPER_IDX;
    }
  ...
  private static Object getInkCartridgeReportType(final Object color) {
    ...
    Boolean success_5 =
        Utils.equals(quotePattern_11, Print_Service.quotes.BlackWhiteQuote.getInstance());

    if (!(success_5)) {
      Object quotePattern_12 = color;
      success_5 = Utils.equals(quotePattern_12, Print_Service.quotes.ColorQuote.getInstance());

      if (success_5) {
        casesExpResult_5 = Print_Service.quotes.ColorInkEmptyQuote.getInstance();
      }

    } else {
      casesExpResult_5 = Print_Service.quotes.BlackInkEmptyQuote.getInstance();
    }
  ...
  private static Object getPaperSizeReportType(final Object paperSize) {
    ...
    Boolean success_6 = Utils.equals(quotePattern_13, Print_Service.quotes.A3Quote.getInstance());

    if (!(success_6)) {
      Object quotePattern_14 = paperSize;
      success_6 = Utils.equals(quotePattern_14, Print_Service.quotes.A4Quote.getInstance());

      if (!(success_6)) {
        Object quotePattern_15 = paperSize;
        success_6 = Utils.equals(quotePattern_15, Print_Service.quotes.A5Quote.getInstance());

        if (success_6) {
          casesExpResult_6 = Print_Service.quotes.A5EmptyQuote.getInstance();
        }

      } else {
        casesExpResult_6 = Print_Service.quotes.A4EmptyQuote.getInstance();
      }

    } else {
      casesExpResult_6 = Print_Service.quotes.A3EmptyQuote.getInstance();
    }
